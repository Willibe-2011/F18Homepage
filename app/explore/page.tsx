...
import { mockProfiles, industries } from "@/lib/data"

const allIndustries = ["Education", "Neurotech", "Tech", "Bio", "Climate", "Arts", "Sports", "Research", "Business"]
        ...
        <div className="mx-auto flex max-w-[1600px] gap-12 px-8 py-16 lg:px-12 lg:py-20">
          ...
          <div className="flex-1">
            ...
            <p className="mt-6 text-base text-muted-foreground lg:text-lg">
              Showing {filteredProfiles.length} of {mockProfiles.length} F18s
            </p>
